...
If your theme has been integrated with WooCommerce it is possibly already adding or removing some of the archive compontents. If so the plugin options may be overwritten regardless of the settings you choose.
...
= I want to style the "new" badge myself, how do I remove the default styles? =
...
function remove_new_badge_styles() {
	wp_dequeue_style( 'nb-new-styles' );
}
`
